...
(async () => {
  ...
  await fs.writeFile("lipid-lowering-agents-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("lipid-lowering-agents-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
